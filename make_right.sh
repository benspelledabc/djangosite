...
docker exec -it benspelledabc_unicorn_web_1 mkdir -p /opt/app/imrunicorn/media/uploads/announcements/what_is_new
docker exec -it benspelledabc_unicorn_web_1 mkdir -p /opt/app/imrunicorn/media/uploads/deer_shots
docker exec -it benspelledabc_unicorn_web_1 mkdir -p /opt/app/imrunicorn/media/uploads/groundhog_kill_shots


echo "Setting Permissions"
docker exec -it benspelledabc_unicorn_web_1 chown -R www-data:www-data /opt/app/imrunicorn
